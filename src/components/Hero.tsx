...
const banners = [
  {
    ...
    description: "Experience the ultimate cleaning power with our premium vacuum cleaners. Trusted by millions of customers worldwide.",
  ...
  },
  {
    ...
    description: "Discover our wide range of premium electronics for your smart home. Quality guaranteed.",
  ...
  },
  {
    ...
    description: "Embrace the future with our latest smart home technologies. Innovation at its finest.",
    image: "https://images.unsplash.com/photo-1603712725655-edb8b84bcf68?w=600&h=400&fit=crop",
    ...
    <section className="py-6 bg-white">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            <CaretLeft size={20} className="text-gray-800" weight="fill" />
          </motion.button>
          ...
          >
            <CaretRight size={20} className="text-gray-800" weight="fill" />
          </motion.button>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center w-full">
              ...
              >
                <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-3 py-1 text-xs font-medium">
                  ✨ {currentBanner.title === "NO.1" ? "No.1 Brand" : currentBanner.title === "BEST" ? "Best Quality" : "New Innovation"}
                </div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold leading-tight">
                  ...
                  <br />
                  <span className="text-white text-2xl md:text-3xl">{currentBanner.subtitle}</span>
                  <br />
                  <span className="text-white text-2xl md:text-3xl">{currentBanner.subtitle2}</span>
                </h1>
